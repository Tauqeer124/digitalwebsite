    ...
    <div class="card-container">
        @foreach($packages as $package)
            <div class="card" onclick="toggleDetails('{{ $package->id }}')">
                <h3>{{ $package->name }}</h3>
                @if($package->id == 1)
                <p>Commission Message: Get 65% commission</p>
            @elseif($package->id == 2)
                <p>Commission Message: Get 70% commission</p>
            @elseif($package->id == 3)
                <p>Commission Message: Get 75% commission</p>
            @elseif($package->id == 4)
                <p>Commission Message: Get 80% commission</p>
            @endif
