...
Route::post('/convert-and-add-to-wallet', [PaymentController::class, 'convertAndAddToWallet'])
    ...
    Route::middleware(['auth', 'admin'])->group(function () {
        Route::get('/admin/add-points/{user}', [AdminController::class, 'showAddPointsForm'])->name('admin.showAddPointsForm');

        // Add a middleware 'admin' to check if the user is an admin
        Route::post('/admin/add-points/{user}', [AdminController::class, 'addPoints'])->name('admin.addPoints');
    });
